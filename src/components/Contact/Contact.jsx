...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // REEMPLAZA ESTOS DATOS CON TUS CREDENCIALES DE EMAILJS
      const result = await emailjs.sendForm(
        'service_32j8etb', // Reemplaza con tu Service ID
        'template_j45efs2', // Reemplaza con tu Template ID
        formRef.current,
        'ChOPxPhHkrp5uVbac' // Reemplaza con tu Public Key
      );
      ...
      setSubmitMessage('Hubo un error al enviar el mensaje. Por favor, intenta de nuevo o contáctame directamente por email.');
          ...
          <div className="contact-info">
            <div className="contact-intro">
              ...
              <p>
                ...
                de colaboración. No dudes en contactarme si tienes alguna 
