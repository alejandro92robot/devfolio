        ...
        <div className='about-content'>
          <div className='about-text'>
            ...
            <div className='about-description'>
              <p>
                Soy un desarrollador apasionado por la ciencia, la tecnología y la innovación. Me
                encanta crear soluciones digitales que impacten positivamente en la vida de las
                personas.
              </p>
              <p>
